...
export default class CreateRideHistory extends React.Component {
  ...
  getPastRides = async () => {
    await db
      ...
      .where("passengerNames", "array-contains", this.state.userId)
      ...
      .onSnapshot((snapshot) => {
        ...
        this.setState({ yourPastRides: rides });
      });
  };
      ...
      <View style={styles.container}>
        <SafeAreaView style={{ flex: 1 }}>
          <View style={styles.heading}>
            <Text style={styles.headingTest}>Your Past Rides</Text>
          </View>
          <FlatList
            data={this.state.yourPastRides}
            onPress={() => this.props.navigation.navigate("Login")}
            renderItem={({ item }) => (
              <TouchableOpacity
                style={styles.list}
                onPress={() => {
                  this.props.navigation.navigate("YourRideDetails", {
                    details: item,
                  });
                }}
              >
